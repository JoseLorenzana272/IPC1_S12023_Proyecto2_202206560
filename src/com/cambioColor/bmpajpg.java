 ...
 * @author PERSONAL
 */
public class bmpajpg extends ImageHandler{
     BufferedImage jpg;
    public static BufferedImage bmp;
    File tmp;
    String nombre;

    public bmpajpg(String filename) {
        super(filename);
        this.jpg = null;
        this.bmp = null;
    ...
    public void generateFiles() throws Exception {
        ImageIO.write(bmp, "jpg", new File("C:\\Users\\PERSONAL\\OneDrive\\Desktop\\IPC1_S12023_Proyecto2_202206560\\Imagen\\"+nombreImg+".jpg"));
    }
}
