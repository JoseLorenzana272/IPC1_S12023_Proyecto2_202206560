 ...
 * @author PERSONAL
 */
public class Hrotacion extends ImageHandler{
    BufferedImage jpg;
    public static BufferedImage bmp;
    File tmp;
    String nombre;

    public Hrotacion(String filename) {
        super(filename);
        this.jpg = null;
        this.bmp = null;
    ...
    public void generateFiles() throws Exception {
        ...
        g2d.drawImage(bmp.getSubimage(0, 0, width, height), width, 0, -width, height, null);
        g2d.dispose();
        ImageIO.write(flippedImage, "jpg", new File("C:\\Users\\PERSONAL\\OneDrive\\Desktop\\IPC1_S12023_Proyecto2_202206560\\Imagen\\Hrotation_"+nombreImg+".jpg"));
