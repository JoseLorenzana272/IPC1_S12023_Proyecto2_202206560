 ...
 * @author PERSONAL
 */
public abstract class CambiarColores extends ImageHandler{
    BufferedImage jpg;
    ...
    public void generateFiles() throws Exception {
        ...
        ImageIO.write(bmp, "jpg", new File("C:\\Users\\PERSONAL\\OneDrive\\Desktop\\IPC1_S12023_Proyecto2_202206560\\Imagen\\Rojo_"+nombreImg+".jpg"));
    }
    
    
    
    public abstract void repintarR(int i, int j, Color color);
