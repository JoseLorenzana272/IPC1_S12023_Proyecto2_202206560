 ...
 * @author PERSONAL
 */
public abstract class CambiarColorAzul extends ImageHandler{
    BufferedImage jpg;
    public static BufferedImage bmp;
    File tmp;
    String nombre;

    public CambiarColorAzul(String filename) {
        super(filename);
        this.jpg = null;
        this.bmp = null;
    ...
    public void generateFiles() throws Exception {
        ...
        ImageIO.write(bmp, "jpg", new File("C:\\Users\\PERSONAL\\OneDrive\\Desktop\\IPC1_S12023_Proyecto2_202206560\\Imagen\\Azul_"+nombreImg+".jpg"));
    }
    
    
    
    public abstract void repintarB(int i, int j, Color color);
}
